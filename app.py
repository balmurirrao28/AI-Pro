...
collection = db.get_or_create_collection("college_schedule_v3")
...
def agent(message):
    ...
    college_question = (
        ...
        and any(word in text for word in [
            "end", "ending", "ends", "finish", "finishing",
...
<button onclick="ask('When is my college ending today?')">
🎓 College Today
</button>
...
<button onclick="ask('What is my college schedule this week?')">
📚 This Week
</button>
